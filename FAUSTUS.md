...
**Verificado en vivo — pendiente.** Esta caja de arena no tiene el servidor de Windows corriendo ni acceso al helper llama.cpp real (`http://127.0.0.1:8082/v1`, alias `qwen2.5-3b-helper`) ni a Piper instalado, así que el flujo completo grabación→transcripción→notas nunca se probó contra un servidor real, y la pestaña Meetings nunca se vio renderizada en un navegador real. 
