...
- Cifras a 02-09-2026 (15:00, en `master`): **185 commits**, +67.000 líneas sobre la base (487 ficheros tocados); **56 módulos nuevos** en `src/`, `routes/` y `static/js/`, **114 ficheros de tests nuevos** (899 en total). Suite completa: **7.580 tests en verde**, 14 saltados, ~7 min en Linux; e2e Playwright 10/10.
- Máquina de referencia: RTX 4070 Ti 12 GB, 128 GB RAM, Windows 11, Ollama 0.33.x; modelos `qwen3-coder:30b`, `qwen3.5:9b` (visión), `qwen3.8:27b`, `qwen3-coder-next`.
