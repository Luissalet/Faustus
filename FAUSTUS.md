...
## 83. Paridad con TrueForge, incremento 1: manifiesto, ejecutor de aceptación y las puertas A01–A07 (13-09-2026)

**El encargo.** Luis subió `Faustus_vs_TrueForge_ContinualHarness_2026-09-13_V2.zip`: una auditoría de ChatGPT (tres agentes y revisión cruzada) que compara Faustus con TrueForge (runtime + SDK + UI embebible, MIT) y con Continual Harness (adaptación continua), con 22 razones para elegir TrueForge, un blueprint (16), auditorías de runtime/producto/aprendizaje (11–13) y 36 recetas de aceptación **propuestas, no ejecutadas**. El objetivo del propietario: «que literalmente no haya ni un solo motivo para usar TrueForge en lugar de Faustus». El dictamen (17) fija la regla: ninguna fila se cierra por existir una clase o por un test simulado; superioridad solo con evidencia; empezar por PR1 (manifiesto + baseline de aceptación) y por A01–A07 (admisión, aprobaciones, replay, recuperación, fencing, cancelación).
