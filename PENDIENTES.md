...
- **Radar de git en tema claro y a 420 px** (FAUSTUS §185/§187): la franja se vio en vivo en Control de versiones (11 de 126 repositorios con trabajo sin salir, con sus insignias); falta verla en tema claro y en ventana estrecha (el Chrome de la prueba no se deja estrechar) y la tarjeta de Inicio con un aviso push real.
