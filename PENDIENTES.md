...
- **Aprobaciones y reinicio**: reiniciar el servidor pierde las tarjetas de aprobación pendientes (almacén en memoria, TTL 30 min, por diseño de seguridad); el turno queda «esperando» y el clic da 409. Decidir si persistirlas (selladas, con su digest) o al menos marcar el turno como «reiniciar desde aquí».
