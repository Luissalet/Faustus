...
- **Umbral de similitud de slots en el 8081** (26-09, §211): al acabar el examen 30, arrancar el 8081 con `--slot-prompt-similarity 0.5` (en la tarea programada y en los `extra_args` del motor en el 7000 y el 7006). Comprobar con dos chats a la vez que uno no le quita la caché al otro: las líneas `[engine] round` de ambos no deben volver a «0 from cache» salvo al empezar.
