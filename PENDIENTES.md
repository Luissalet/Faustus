...
- **Marcas de cita crudas**: «Faltan 91 días para Navidad … [L-000010]» — el id de cita de Laplace's Hoard sale tal cual en la respuesta; o se muestra como cita enlazada o no se pide al modelo que lo copie.
...
- Preguntas sobre algo que el usuario pidió recordar: el 27B va primero al calendario (y a veces al cerebro) aunque el recuerdo esté en el prompt. Probar a situar el bloque de recuerdos junto al mensaje del usuario, o una comprobación que vea «no lo encuentro» con un recuerdo recuperado que comparte las palabras de la pregunta.
