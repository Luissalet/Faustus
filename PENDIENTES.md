...
- CERRADO (2a9ac1a1): un saludo en modo agente viajaba con TODO el juego de herramientas adjunto, y el motor tenía que leérselo entero antes de decir una palabra. Medido en vivo con la misma pregunta y el mismo motor: 7,7 s con herramientas, 3,0 s en modo chat sin ellas, 3,7 s en modo agente ya con el arreglo. Decide `turn_effort.wants_tools`, la misma lista blanca que ya gobierna el razonamiento. Comprobado que la conversación sigue teniendo herramientas justo después.
