...
- **Afinidad de sesión en OpenRouter** (26-09, investigación de APIs, sin verificar): comprobar en su documentación si hay un campo de sesión que fije el proveedor de origen y así no se pierda la caché entre llamadas.
