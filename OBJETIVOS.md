...
- **No repetir lecturas caras entre turnos** (26-09, investigación ronda 5): una llamada de solo lectura con los mismos argumentos que una del turno anterior (sobre todo `inspect_image`, que tarda minutos) podría devolver el resultado ya obtenido si el fichero no ha cambiado desde entonces; hace falta guardar la fecha del fichero con el evento.
