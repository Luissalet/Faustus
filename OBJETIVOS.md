...
- **Juego de herramientas por chat que sobreviva a un reinicio** (26-09, §211): `_sticky_toolset` vive en memoria; tras reiniciar Faustus, el primer turno de cada chat elige otro juego y el servidor relee el prompt entero (16,5k tokens, 32 s en el 27B). Guardarlo con la sesión.
