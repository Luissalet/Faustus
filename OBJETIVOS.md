...
|---|---|---|
| Correo de workflows | Adjuntos, HTML y CC/BCC; este canal sólo acepta texto y destinatarios principales. El compositor de correo es otra función. | [delivery.py](src/workflows/delivery.py), `_prepare` |
...
| Bitwarden | Evitar persistir la sesión en claro, o cifrarla y aplicar caducidad. Los permisos del archivo no sustituyen el cifrado. | [vault_routes.py](routes/vault/vault_routes.py) |
