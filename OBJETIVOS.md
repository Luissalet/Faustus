...
- **Síntesis de un reparto que diga quién hizo qué** (26-09, idea de agents-office): cuando `delegate_agents` devuelve varios informes, pedir que la respuesta final atribuya cada parte al trabajador que la hizo.
