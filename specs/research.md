...
- research CLI access in `scripts/faustus-research`;
...
- Decide whether direct JSON access by `manage_research` and `scripts/faustus-research` must be owner-filtered like browser routes or is local/tool-only.
