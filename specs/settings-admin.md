...
- CLI helpers `scripts/faustus-preset` and `scripts/faustus-theme`.
...
`scripts/faustus-preset` is a local CLI for preset store maintenance and backup of `presets.json`.
