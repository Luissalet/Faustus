...
- **Tu WhatsApp, leído y contestado desde aquí**: empareja tu cuenta por QR (protocolo multidispositivo de WhatsApp Web, un puente Node local en el loopback con token) y pide «qué me han escrito hoy», «resume lo que me ha dicho Ana» o «dile a Ana que llego diez minutos tarde» — cada envío lo apruebas tú; un resumen diario de WhatsApp puede ser una tarjeta de Inicio; Tools → WhatsApp muestra chats, mensajes y un compositor.
