...
- **Las herramientas del dominio desde la primera vuelta.** Si la petición es claramente de un dominio (calendario, notas, tareas, correo, WhatsApp, contactos, documentos, chats, escritorio, medios, integraciones), sus herramientas de uso diario van como esquema completo desde la primera vuelta aunque la búsqueda vectorial no las encuentre, sin pasar antes por `lookup_tools`. El índice de herramientas sólo vuelve a embeber las herramientas MCP cuya descripción cambió.
