...
- Sincroniza **Google Calendar como Google lo permite**: OAuth2 («Connect with Google», el mismo cliente que Gmail) y la Calendar API v3, descargas incrementales con `syncToken`, recurrencias y cancelaciones, escritura de vuelta protegida por etag; iCloud, Nextcloud y cualquier otro CalDAV siguen con el formulario de contraseña ([Google Calendar](docs/api/google_calendar.md)).
