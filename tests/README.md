...
```text
[order-report] working directory: /path/to/faustus
...
[order-report] reproduce with: /path/to/faustus/venv/bin/python /path/to/faustus/tests/run_order_report.py --seed 284734921 -- tests/cli/ -q
```
