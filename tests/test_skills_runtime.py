...
def test_a_pre_rename_odysseus_skills_folder_is_still_discovered(tmp_path):
    """A project created before the identifier rename (18-09-2026) still
    has its skills under `.odysseus/skills`; discovery must find them
    read-only when no `.faustus/skills` folder exists yet."""
