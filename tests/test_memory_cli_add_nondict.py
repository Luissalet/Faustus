"""cmd_add (scripts/faustus-memory) must tolerate a non-dict row in the
...
def _load_cli(monkeypatch):
    ...
    path = ROOT / "scripts" / "faustus-memory"
    loader = importlib.machinery.SourceFileLoader("faustus_memory_cli_add", str(path))
