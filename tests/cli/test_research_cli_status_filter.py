"""`faustus-research list --status complete` was returning nothing.
...
Part of #2122 (faustus-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "faustus-research"
    loader = importlib.machinery.SourceFileLoader("faustus_research_cli", str(path))
