...
try:
    ...
    # Faustus is single-process by convention, so this is acceptable, but be aware that
...
if AUTH_ENABLED:
    ...
    def _is_trusted_loopback(request: Request) -> bool:
        ...
        slip past LOCALHOST_BYPASS or spoof the internal-tool path. Faustus's own
...
from routes.creator_plan_routes import setup_creator_plan_routes  # WP22
...
from routes.creator_render_routes import setup_creator_render_routes  # WP14
...
from routes.creator_subtitle_routes import setup_creator_subtitle_routes  # WP16
