                        ...
                        if jm:
                            ...
                            if urgency in ("critical", "high"):
                                try:
                                    ...
                                    # Deep-link to open the original email in Faustus (if public URL is configured).
                                    ...
                                    # HTML alternative with a clickable "Open in Faustus" button
                                    import html as _h
