...
- [ ] I searched [open issues](https://github.com/faustus-dev/faustus/issues) and [open PRs](https://github.com/faustus-dev/faustus/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses Faustus's existing visual language. Specifically:
