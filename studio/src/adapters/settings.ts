...
export const KEYBIND_LABELS: Record<string, string> = {
  ...
  toggle_sidebar: 'Mostrar u ocultar la barra',
  new_session: 'Nueva conversación',
  fav_session: 'Marcar favorita',
  delete_session: 'Borrar la conversación (dos veces)',
  cancel: 'Cancelar / parar',
  tts: 'Leer la última respuesta',
  incognito: 'Modo incógnito',
  settings: 'Ajustes',
  focus_input: 'Ir al compositor',
  open_calendar: 'Abrir el calendario',
  open_compare: 'Abrir Compare',
  open_cookbook: 'Abrir el Cookbook',
  open_research: 'Abrir Deep Research',
  open_gallery: 'Abrir las imágenes',
  open_library: 'Abrir la Biblioteca',
  open_memory: 'Abrir la Memoria',
  open_notes: 'Abrir las Notas',
  open_tasks: 'Abrir las Automatizaciones',
  open_theme: 'Abrir el tema',
};
