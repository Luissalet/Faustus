...
WRITING_TOOLS: Tuple[str, ...] = ("write_file", "edit_file", "apply_patch", "bash", "python", "powershell")
    ...
    # change made stale.
    {
        ...
        "frontmatter": {
            ...
            "tools": ["read_file", "ls", "glob", "grep", "get_workspace", "write_file",
                      "edit_file", "apply_patch", "bash", "python", "powershell", "todowrite", "update_plan"],
...
establish. An unsupported claim costs more than a missing one.""",
    ...
    # analysis is separate work that happens afterwards.
    {
        ...
        "frontmatter": {
            ...
            "mode": "coordinator",
            "tools": ["read_file", "ls", "glob", "grep", "get_workspace", "bash", "python", "powershell",
    ...
    # the cut is assembled here.
    {
        ...
        "frontmatter": {
            ...
            "tools": ["read_file", "ls", "glob", "grep", "get_workspace", "generate_image",
                      "edit_image", "write_file", "bash", "python", "powershell", "create_document",
                      "delegate_agents", "todowrite", "update_plan"],
            "permission": ["allow read **", "allow write **", "allow delegate *"],
            "max_rounds": 30,
            "timeout_s": 7200,
...
rebuilds the cut from scratch.""",
    ...
    # be exactly the self-declared competence §14 refuses to weigh.
    {
        ...
        "frontmatter": {
            ...
            "mode": "coordinator",
            "tools": ["read_file", "ls", "glob", "grep", "get_workspace", "write_file",
                      "edit_file", "apply_patch", "bash", "python", "powershell", "manage_bg_jobs",
                      "delegate_agents", "todowrite", "update_plan"],
