...
EXTRA_KEYS: tuple[str, ...] = ("tool_path_extra_roots", "vision_enabled", "vision_model",
                              "vision_timeout_seconds", "vision_max_side", "vision_max_side_limit",
                               "vision_max_tokens",
...
GROUPS: list[dict[str, Any]] = [
    _group(
        ...
        [
            ...
            _int("agent_web_streak_nudge", "Research-streak nudge threshold",
                 ...
                 0, 100),
            _int("agent_todo_stall_nudge", "Stalled plan-step nudge",
    ...
    _group(
        ...
        [
            ...
            _int("vision_max_side_limit", "Vision image size limit (px)",
                 "The most the agent may ask for with max_side when the Vision model answers. "
                 "Larger images cost minutes on a CPU vision model.", 256, 4096),
