...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "whatsapp_send": "Send a WhatsApp message from the user's own account to a contact, group or phone: 'dile a X que…', 'mándale a X', 'escríbele a X por whatsapp', 'contesta a X', 'avisa al grupo'. The user approves each send.",
...
class ToolIndex:
    ...
    _KEYWORD_HINTS = {
        ...
        frozenset({"whatsapp", "wasap", "guasap", "whats", "dile a", "mándale", "mandale", "escríbele", "escribele",
            ...
            {"whatsapp_read", "whatsapp_send", "ask_user"},
