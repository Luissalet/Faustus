...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "inspect_image": "Look closely at ONE image, photo, scan or PDF page: crop a region, zoom, rotate, enhance (autocontrast/sharpen/grayscale/threshold), overlay a labelled grid (cells like C4), and ask the vision model a SPECIFIC question about it -- or detect circles/rectangles/lines locally with no model at all, or compare two images. Use this instead of trusting read_file's automatic caption when a small detail (which object a hand-drawn circle marks, a tilted symbol, faint handwriting, where exactly something is) needs a precise, targeted look. Imagen, foto, zoom, recorta, amplía, gira, círculo, marca, dibujo, pergamino, escaneo, cuadrícula, compara dos imágenes.",
