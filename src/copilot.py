...
COPILOT_USER_AGENT = os.environ.get(
    "FAUSTUS_COPILOT_USER_AGENT", "Faustus/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "FAUSTUS_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "FAUSTUS_COPILOT_EDITOR_VERSION", "Faustus/1.0"
)
