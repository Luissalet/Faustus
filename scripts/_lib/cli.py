"""scripts/_lib/cli.py — shared scaffolding for the `faustus-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("faustus-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/faustus-foo`
...
VERSION = "0.1.0"  # bumped centrally; every faustus-* CLI reports this
