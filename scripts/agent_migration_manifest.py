...
This helper is intentionally read-only. It does not import the Faustus
application package, write to data/, call an LLM, or apply anything. It turns
common agent export shapes into a portable JSON manifest that Faustus can
...
def parse_args(argv: list[str] | None = None):
    parser = argparse.ArgumentParser(description="Build a neutral Faustus agent migration manifest.")
